...
# MAGIC %md
# MAGIC # Now accessing the data and perparing it for the segmentation
...
(spark.read.csv('/tmp/completejourney/bronze/transaction_data.csv',header=True,schema=transactions_schema).write.format('delta').mode('overwrite').option('overwriteSchema', 'true').save('/tmp/completejourney/completejourney/silver/transactions'))
...
# DBTITLE 1,campaign-household realtionships
# delete the old table if needed
...
# MAGIC %md
# MAGIC # Adjusting Transactional Data

# COMMAND ----------

# DBTITLE 1,adjusted tarnsactions
# MAGIC %sql
# MAGIC  
...
# MAGIC %sql
# MAGIC SELECT 
# MAGIC   COUNT(DISTINCT household_id) as uniq_households_in_transaction,
...
# DBTITLE 1,transaction line items flagged for promotional influence
# MAGIC %sql
# MAGIC  
# MAGIC WITH 
